...
folder are mapped to the application's root namespace, 'Youngshine'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Youngshine"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Youngshine' in the same way
as `"Youngshine/sass/src"`.
